...
and [1973](https://doi.org/10.1214/aos/1176342503)). 
...
```{r phosphor, fig.width=6, fig.height=6} 
...
but [Yohai (1987)](https://doi.org/10.1214/aos/1176350366) showed 
...
```{r stackloss2, fig.width=5.5, fig.height=5.5}
